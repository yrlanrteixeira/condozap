...
export const ComplaintPriorityEnum = z.enum(['critical', 'high', 'medium', 'low']);
...
export const ComplaintSchema = z.object({
  ...
  category: z.enum(COMPLAINT_CATEGORIES, {
    errorMap: () => ({ message: 'Categoria inválida. Escolha: Barulho, Manutenção, Segurança, Limpeza ou Outros' }),
  }),
  content: z.string()
